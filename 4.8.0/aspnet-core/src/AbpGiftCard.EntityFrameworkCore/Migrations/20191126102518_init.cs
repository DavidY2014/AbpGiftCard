    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Catelogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "CouponFinanceDetails",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    PayMethod = table.Column<int>(nullable: false),
                    ReturnPayTime = table.Column<DateTime>(nullable: false),
                    IsOpenBill = table.Column<bool>(nullable: false),
                    ...
                    TaxIdentityNumber = table.Column<string>(nullable: true),
                    OpenBank = table.Column<string>(nullable: true),
                    OpenBankAccount = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CouponFinanceDetails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxTitle = table.Column<string>(nullable: false),
                    Openbank = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BelongSupplierName = table.Column<string>(nullable: true),
                    SupplierId = table.Column<int>(nullable: false),
                    Class1Id = table.Column<int>(nullable: false),
                    Class1Name = table.Column<string>(nullable: true),
                    Class2Id = table.Column<int>(nullable: false),
                    Class2Name = table.Column<string>(nullable: true),
                    Cost = table.Column<double>(nullable: false),
                    SalePrice = table.Column<double>(nullable: false),
                    TotalStock = table.Column<int>(nullable: false),
                    SaledStock = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartRangeNumber = table.Column<int>(nullable: false),
                    EndRangeNumber = table.Column<int>(nullable: false),
                    CouponStatus = table.Column<int>(nullable: false),
                    OperatorName = table.Column<string>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    IsSignContact = table.Column<bool>(nullable: false),
                    ContractRefId = table.Column<int>(nullable: true),
                    ActiveMethod = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CouponOrders_Contracts_ContractRefId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinanceContactor = table.Column<string>(nullable: false),
                    FinancePhone = table.Column<string>(nullable: true),
                    DeliveryName = table.Column<string>(nullable: false),
                    DeliveryPhone = table.Column<string>(nullable: true),
                    CompanyName = table.Column<string>(nullable: true),
                    CompanyAddress = table.Column<string>(nullable: true),
                    ServiceContactor = table.Column<string>(nullable: true),
                    ServicePhone = table.Column<string>(nullable: true),
                    FinanceRefId = table.Column<int>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Suppliers_Finances_FinanceRefId",
                        column: x => x.FinanceRefId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(nullable: false),
                    BelongSupplierName = table.Column<string>(nullable: true),
                    BelongSupplierId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CouponOrders_ContractRefId",
                table: "CouponOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_FinanceRefId",
                table: "Suppliers",
                column: "FinanceRefId");
        }
